...
describe('[New] Beatrix CMS: Create Slide Show - Slides', function() {
    ...
    var cmsNoSlides = element.all(by.xpath(browser.params.cmsNoSlidesAddedXpath)).first();
    ...
    var cmsComponent1 = element(by.css('#new_slide_en > table:nth-child(1) > thead'));
    var cmsComponent2 = element(by.css('#new_slide_en > table:nth-child(2) > thead'));
    var cmsComponent3 = element(by.css('#new_slide_en > table:nth-child(3) > thead'));
    ...
    it('Scenario 3: No Slides Added', function(){
      expect(cmsNoSlides.isDisplayed()).toBe(true);
