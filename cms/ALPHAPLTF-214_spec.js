...
describe('Beatrix CMS: Create Slide - Language tabs available per Brand', function() {
  ...
  it('If the brand is Slots LV, it would return three language tabs (en,zh-hans)', function(){
    //CHOOSE BRAND
    element(by.css('bx-brand-select')).element(by.css('bx-dropdown')).click();
    browser.sleep(5000);
